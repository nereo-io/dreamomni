...
const applyHref = 'https://dreamomni.firstpromoter.com';
...
const programHighlights = [
  {
    title: '30% Commission',
    description:
      'Earn 30% recurring commission on qualified DreamOmni purchases you refer.',
...
const affiliateSteps = [
  {
    ...
    description:
      'Tell us about your audience, channels, and how you plan to promote DreamOmni.',
    icon: Send,
  },
  {
...
const partnerReasons = [
  {
    ...
    description:
      'DreamOmni gives video creators practical tools for image-to-video, text-to-video, and AI media workflows.',
    icon: Sparkles,
  },
  {
...
const dos = [
  ...
  'Send users to DreamOmni pages that match their intent.',
...
const donts = [
  ...
  'Do not bid on DreamOmni branded terms or impersonate DreamOmni.',
];

const faqs = [
  {
    question: 'Who can join the DreamOmni affiliate program?',
    answer:
  ...
  },
  {
    ...
    answer:
      'DreamOmni uses a 90-day cookie window. If a qualified visitor purchases within that period, the referral can be attributed to you.',
  },
  {
  ...
  {
    question: 'Can I promote DreamOmni with paid ads?',
    answer:
...
export async function generateMetadata({
  ...
  return {
    title: 'DreamOmni Affiliate Program',
    ...
    <div className="flex flex-col items-center text-foreground">
      ...
      <section id="program-details" className={modelSectionClass}>
        <div className="mx-auto max-w-7xl px-4 md:px-8">
          <SectionHeading
            ...
            description="DreamOmni affiliates get a clear commission model, a generous attribution window, and straightforward monthly PayPal payouts."
          />
      ...
      <section id="why-partner" className={modelSectionClass}>
        <div className="mx-auto max-w-7xl px-4 md:px-8">
          <SectionHeading
            eyebrow="Why"
            title="Why Partner with DreamOmni?"
            description="DreamOmni is built for creators who want practical AI media workflows, making it easier for partners to promote with real use cases."
          />
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      ...
      <section id="promotion-rules" className="w-full bg-gray-950 py-16 md:py-24">
        <div className="mx-auto max-w-7xl px-4 md:px-8">
          <SectionHeading
            ...
            title="Dos and Don'ts for Promoting DreamOmni"
        ...
        <div className='relative flex min-h-[400px] items-center justify-center bg-[url("/imgs/cta-bg.png")] bg-cover bg-center bg-no-repeat py-20 text-center'>
          ...
          <div className="relative z-10 mx-auto max-w-4xl px-8">
            <h2 className="mb-6 text-balance text-3xl font-bold leading-tight tracking-tight text-white md:text-4xl lg:text-5xl">
              Ready to partner with DreamOmni?
            </h2>
