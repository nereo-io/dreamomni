...
export default function AddInstrumentalClient() {
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 py-8 md:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
          <div className="relative group">
            <div className="absolute inset-0 bg-gradient-to-br from-green-500/10 to-purple-500/10 rounded-3xl blur-2xl group-hover:blur-3xl transition-all"></div>
            <div className="relative bg-card/40 backdrop-blur-xl rounded-3xl p-6 md:p-8 border border-border/50 shadow-2xl">
              ...
              <MusicGeneratorForm
                ...
                fixedGenerationType="add-instrumental"
              />
            </div>
          </div>

          <div className="relative group">
            <div className="absolute inset-0 bg-gradient-to-br from-purple-500/10 to-green-500/10 rounded-3xl blur-2xl group-hover:blur-3xl transition-all"></div>
            <div className="relative bg-card/40 backdrop-blur-xl rounded-3xl p-6 md:p-8 border border-border/50 shadow-2xl">
              <div className="flex items-center gap-3 mb-6">
                <div className="p-2 bg-purple-500/10 rounded-lg">
                  <Guitar className="h-6 w-6 text-purple-400" />
                </div>
                <h2 className="text-xl md:text-2xl font-semibold text-white">
