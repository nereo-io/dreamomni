...
> Generate videos from images using the Sora 2 Image To Video model
...
- **Best Practices**:
  ...
  - The prompt should describe the motion/animation you want, not the static content (which is already in the image)
  - Ensure the aspect ratio of your source image matches the selected `aspect_ratio` parameter
