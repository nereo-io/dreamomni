...
export function FeedbackSection({ isCollapsed }: FeedbackSectionProps) {
  ...
  const handleDiscord = () => {
    window.open("https://discord.gg/pBmsgE8s", "_blank");
  };
    ...
    <div className="mb-3 px-1">
      <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10">
        ...
        <div className="space-y-2">
          <button
            className="w-full flex items-center space-x-3 text-sm text-gray-300 hover:text-white transition-colors group"
            onClick={handleTelegram}
          >
            <svg
